...
[![Groq](https://img.shields.io/badge/Groq-Llama-F55036?style=for-the-badge&logo=data%3Aimage%2Fpng%3Bbase64%2C&logoColor=white)](https://groq.com)
[![License](https://img.shields.io/badge/License-MIT-yellow.svg?style=for-the-badge)](./LICENSE)

[![Stars](https://img.shields.io/github/stars/pivotvault/pivotvault?style=social)](https://github.com/pivotvault/pivotvault/stargazers)
[![Forks](https://img.shields.io/github/forks/pivotvault/pivotvault?style=social)](https://github.com/pivotvault/pivotvault/network/members)
[![Issues](https://img.shields.io/github/issues/pivotvault/pivotvault?color=orange)](https://github.com/pivotvault/pivotvault/issues)
...
> [!NOTE]
> Drop your own screenshots or screen recordings into `/screenshots` and swap in the image links above (`![Failure Explorer](./screenshots/failure-explorer.png)`) once the UI is ready to showcase.
...
```mermaid
flowchart TD
    A[💡 Founder Idea] --> B[🎯 Risk Scanner]
    B --> C[🪦 Failure Database]
    C --> D[🌐 Live Web Search]
    D --> E[🤖 Gemini + Groq AI]
    E --> F[📊 Insights Engine]
    F --> G[📋 Recommendations]
    ...
    style A fill:#8E75B2,stroke:#333,color:#fff
    style H fill:#38BDF8,stroke:#333,color:#fff
    style E fill:#F55036,stroke:#333,color:#fff
```
